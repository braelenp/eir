...
// node_modules/@solana/spl-token-metadata/node_modules/@solana/options/dist/index.browser.mjs
...
function getPublicKeyEncoder2() {
  return transformEncoder2(fixEncoderSize2(getBytesEncoder2(), 32), (publicKey2) => publicKey2.toBytes());
}
...
function createEmitInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(new Uint8Array([
      ...
      ["start", getOptionEncoder(getU64Encoder2())],
      ["end", getOptionEncoder(getU64Encoder2())]
